...
// FuzzyInput
FuzzySet stopedInput = FuzzySet(0, 0, 0, 0);
FuzzySet slowInput = FuzzySet(1, 10, 10, 20);
FuzzySet normalInput = FuzzySet(15, 30, 30, 50);
FuzzySet quickInput = FuzzySet(45, 60, 70, 70);

// FuzzyInput
FuzzySet cold = FuzzySet(-30, -30, -20, -10);
FuzzySet good = FuzzySet(-15, 0, 0, 15);
FuzzySet hot = FuzzySet(10, 20, 30, 30);
...
// FuzzyOutput
FuzzySet stopedOutput = FuzzySet(0, 0, 0, 0);
FuzzySet slowOutput = FuzzySet(1, 10, 10, 20);
FuzzySet normalOutput = FuzzySet(15, 30, 30, 50);
FuzzySet quickOutput = FuzzySet(45, 60, 70, 70);
...
void setup()
{
  ...
  // Building FuzzyRule
  FuzzyRuleAntecedent distanceNearAndSpeedQuick = FuzzyRuleAntecedent();
  distanceNearAndSpeedQuick.joinWithAND(&near, &quickInput);
  FuzzyRuleAntecedent temperatureCold = FuzzyRuleAntecedent();
